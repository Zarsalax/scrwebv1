...
log_messages = []
channelid = -1003101739772  # ID del canal SCR VIP RDA
approved_count = 0
declined_count = 0
...
💵 **GATE:** {gate}"""
        ...
        try:
            # Ruta de la imagen (debe estar en el directorio del proyecto)
            image_path = 'x1.jpg'

            buttons = [Button.url('🔥 Buy VIP', 'https://t.me/rushnet')]
            ...
            if os.path.exists(image_path):
                ...
                log_messages.append(f"✓ Enviado al canal sin imagen (x1.jpg no encontrado)")
...
def index():
    ...
    <body>
        ...
        <form action="/set_channel" method="post">
            <input type="text" name="channel" placeholder="Ej: @canal o ID numérico" value="-1003101739772"/>
